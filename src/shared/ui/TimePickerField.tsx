  ...
  return (
    <div className="grid gap-1.5">
      ...
      {pickerRect && typeof document !== 'undefined' && createPortal(
        <>
          <div className="fixed inset-0 z-[120]" onClick={() => setPickerRect(null)} />
          <div
            className="fixed z-[121] overflow-hidden rounded-xl border border-[#e8e8e4] bg-white shadow-[0_16px_36px_-12px_rgba(15,17,21,.25)] dark:border-white/10 dark:bg-[#2D2D31]"
