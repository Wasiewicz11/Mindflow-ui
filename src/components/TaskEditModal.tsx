          ...
          <div style={{ marginTop: 12 }}>
            ...
            <div className="relative">
              ...
              {showProjectPicker && (
                <div
                  className="absolute left-[88px] top-full mt-1 z-20 rounded-xl overflow-hidden"
                  style={{ background: '#fff', border: '1px solid #e8e8e4', boxShadow: '0 8px 24px -6px rgba(15,17,21,.16)', minWidth: 180 }}
                >
                  <button
              ...
              {showDatePicker && (
                <div className="absolute left-[88px] top-full mt-1 z-20">
                  <input
                    ...
                    className="outline-none text-[13px] rounded-xl"
                    style={{ background: '#fff', border: '1px solid #e8e8e4', padding: '8px 12px', boxShadow: '0 8px 24px -6px rgba(15,17,21,.16)' }}
                  />
                </div>
              )}
            </div>
